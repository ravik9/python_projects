...
def win_check(play):
	if ((value[1] == value[2] == value[3] == play.marker) or (value[4] == value[5] == value[6] == play.marker) or (value[7] == value[8] == value[9] == play.marker)):
		return True
	elif ((value[1] == value[4] == value[7] == play.marker) or (value[2] == value[5] == value[8] == play.marker) or (value[3] == value[6] == value[9] == play.marker)):
		play.win()
		return True
